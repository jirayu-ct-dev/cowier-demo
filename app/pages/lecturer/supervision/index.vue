...
import { Eye, RotateCcw, Search, UserMinus, UserPlus, X } from '@lucide/vue'
        ...
        <div class="hidden overflow-x-auto md:block">
          <table class="w-full min-w-[1180px] table-fixed border-collapse text-left text-sm">
            ...
            <thead class="bg-surface text-xs font-semibold tracking-wide text-muted uppercase">
              <tr><th scope="col" class="w-60 px-5 py-3">สถานประกอบการ</th><th scope="col" class="w-44 px-4 py-3">วันและช่วงเวลา</th><th scope="col" class="w-48 px-4 py-3">กลุ่มรับผิดชอบ</th><th scope="col" class="w-64 px-4 py-3">อาจารย์ผู้เข้าร่วม</th><th scope="col" class="w-36 px-4 py-3">นักศึกษา</th><th scope="col" class="w-56 px-4 py-3 text-right"><span class="sr-only">การทำงาน</span></th></tr>
            </thead>
