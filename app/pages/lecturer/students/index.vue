...
const filteredStudents = computed(() => {
  ...
  return people.value
    ...
    .filter((person) => {
      ...
      const searchable = [person.id, person.firstName, person.lastName, ...history.map(item => item.company)]
